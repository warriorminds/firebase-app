...
public class IniciarSesionEmailPasswordActivity extends AppCompatActivity {
    ...
    private void inicializarAutenticacion() {
        ...
        listenerAutenticacion = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                 ...
                 */
                if (usuario != null) {
                    Toast.makeText(IniciarSesionEmailPasswordActivity.this, "Usuario: " + usuario.getEmail(), Toast.LENGTH_SHORT).show();
                    botonCerrarSesion.setVisibility(View.VISIBLE);
                    deshabilitarActivarCampos(false);
                    asignarUsuario(usuario);
                } else {
                    Toast.makeText(IniciarSesionEmailPasswordActivity.this, "Usuario sin sesión", Toast.LENGTH_SHORT).show();
                }
            }
        };
    }
    ...
    private void inicializarVistas() {
        ...
        /**
         * Este Observador nos ayuda a saber si el usuario puso un email y un password válido.
         *
        ...
        TextWatcher observadorTexto = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (esFormaValida(email.getText().toString(), password.getText().toString())) {
        ...
        botonIniciarSesion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                iniciarSesion(email.getText().toString(), password.getText().toString());
            }
        });
    ...
    private void iniciarSesion(String email, String password) {
        ...
        /**
         * Este método se utiliza para iniciar sesión con email y password. Se agrega un
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(IniciarSesionEmailPasswordActivity.this, R.string.hubo_error, Toast.LENGTH_SHORT).show();
                        } else {
    ...
    private void deshabilitarActivarCampos(boolean activar) {
        ...
        password.setEnabled(activar);
        botonIniciarSesion.setEnabled(activar);
    }

    /**
     * Método que obtiene el email del usuario y lo asigna a una text view.
